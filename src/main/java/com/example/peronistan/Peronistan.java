...
public class Peronistan
{
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "peronistan" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "peronistan" namespace
    ...
    // Creates a new Block with the id "peronistan:example_block", combining the namespace and path
    public static final RegistryObject<Block> EXAMPLE_BLOCK = BLOCKS.register("example_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    // Creates a new BlockItem with the id "peronistan:example_block", combining the namespace and path
